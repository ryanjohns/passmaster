...
This project is tested to run on ruby 3.2.3 so you should have that version
...
You will also need a variant of PostgreSQL 14 (anything 9.1 and newer should also work).
